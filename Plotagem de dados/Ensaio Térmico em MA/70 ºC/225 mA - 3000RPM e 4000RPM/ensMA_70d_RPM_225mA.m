...
%% Extracao dos dados experimentais do ensaio térmico em MA com Tamb = 60ºC  Ifreio = 185 mA e diferentes vel rotações

nCol   = 5; % numero colunas
nColl  = 6;
nColll = 13;

nSam  = 21068; %numero de amostras
nSam2 = 4227;

fName = '20231106_150334_meas_medsFreio__b.txt';  %valores de tensão e corrente
gName = '20231106_150334_meas_medsWatt__b.txt';   %valores de potencia
hName = '20231106_150334_meas_medsETMA__b.txt';   %temperaturas dos termopares do IF
