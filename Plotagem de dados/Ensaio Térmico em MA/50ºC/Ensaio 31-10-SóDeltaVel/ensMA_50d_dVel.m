...
%% Extracao dos dados experimentais do ensaio térmico em MA com Tamb = 50ºC,diferentes Vel, sem carga

nCol   = 5; % numero colunas
nColl  = 6;
nColll = 13;

nSam  = 44338; %numero de amostras
nSam2 = 8879;

fName = '20231031_165235_meas_medsFreio__b.txt';  %valores de tensão e corrente
gName = '20231031_165235_meas_medsWatt__b.txt';   %valores de potencia
hName = '20231031_165235_meas_medsETMA__b.txt';   %temperaturas dos termopares do IF
