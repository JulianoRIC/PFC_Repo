...
%% Extracao dos dados experimentais do ensaio térmico em MA com Tamb = 60ºC  Ifreio = 225 mA e diferentes vel rotações

nCol   = 5; % numero colunas
nColl  = 6;
nColll = 13;

nSam  = 28882; %numero de amostras
nSam2 = 5795;

fName = '20231101_162557_meas_medsFreio__b.txt';  %valores de tensão e corrente
gName = '20231101_162557_meas_medsWatt__b.txt';   %valores de potencia
hName = '20231101_162557_meas_medsETMA__b.txt';   %temperaturas dos termopares do IF
