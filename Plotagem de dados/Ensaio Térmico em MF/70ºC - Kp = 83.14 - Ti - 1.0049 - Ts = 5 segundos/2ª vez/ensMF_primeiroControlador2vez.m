...
nSam  = 3601; %numero de amostras

fName = '20231121_141013_meas_medsFreio__b.txt';  %valores de tensão e corrente
gName = '20231121_141013_meas_medsWatt__b.txt';   %valores de potencia
hName = '20231121_141013_meas_medsETMA__b.txt';   %temperaturas dos termopares do IF e MA
iName = '20231121_141013_meas_medsETMF__b.txt';   %temperaturas dos termopares do IF e MF
...
plot(minutos,vecSP)
hold off
axis([28 minutos(end) 65.5 68.015])
legend('PV','SP');
xlabel('tempo [min]')
ylabel('Temperatura [ºC]')
subplot(2,1,2)
