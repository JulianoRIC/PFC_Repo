...
nSam  = 2909; %numero de amostras

fName = '20231121_131222_meas_medsFreio__b.txt';  %valores de tensão e corrente
gName = '20231121_131222_meas_medsWatt__b.txt';   %valores de potencia
hName = '20231121_131222_meas_medsETMA__b.txt';   %temperaturas dos termopares do IF e MA
iName = '20231121_131222_meas_medsETMF__b.txt';   %temperaturas dos termopares do IF e MF
...
plot(minutos,vecSP)
hold off
axis([18 minutos(end) 65.5 68.015])
legend('PV','SP');
xlabel('tempo [min]')
ylabel('Temperatura [ºC]')
subplot(2,1,2)
plot(minutos,vecMV)
axis([18 minutos(end) 0 0.325])
xlabel('tempo [min]')
ylabel('Corrente [A]')
